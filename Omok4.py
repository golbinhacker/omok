...
class Menu(object):
    ...
    def draw_menu(self):
        ...
        self.new_rect = self.make_text(self.font, 'Dash hae', blue, None, top - 30, left)
        self.quit_rect = self.make_text(self.font, 'Ahn hae ssibal', blue, None, top, left)
        self.show_rect = self.make_text(self.font, 'Hide Number', blue, None, top - 60, left)
        self.undo_rect = self.make_text(self.font, 'Ah, han su man', blue, None, top - 150, left)
